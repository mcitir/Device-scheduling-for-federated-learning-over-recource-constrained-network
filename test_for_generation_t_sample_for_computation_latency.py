from utils.custom_utils import generate_t_sample_for_computation_latency
...
# genereta 200 samples from the distribution of computation latency and store u and t_sample in a list
u_list = []
t_sample_list = []

for i in range(200):
    u, t_sample = generate_t_sample_for_computation_latency(FLUCTUATION_COMPUTATION, MAX_COMPUTATION, UNIFORM_DATASET_SIZE)
    u_list.append(u)
